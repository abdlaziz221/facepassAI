<x-app-layout>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 12px;">
        ...
        <a href="#" class="quick-action" title="Tous les pointages — à venir" style="opacity: 0.55; cursor: not-allowed;">
            <span class="icon">
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <a href="#" class="quick-action" title="Tableau retards & départs — à venir" style="opacity: 0.55; cursor: not-allowed;">
            <span class="icon">
                <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            ...
            <div>
                ...
                <div class="subtitle">Vue détaillée par employé</div>
            </div>
        </a>
    </div>
</x-app-layout>
