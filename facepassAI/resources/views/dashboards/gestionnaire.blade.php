<x-app-layout>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 12px;">
        <a href="#" class="quick-action" title="Validation des demandes — à venir (Sprint 4)" style="opacity: 0.55; cursor: not-allowed;">
            <span class="icon">
            ...
            <div>
                ...
                <div class="subtitle">5 demandes en attente</div>
            </div>
        </a>
